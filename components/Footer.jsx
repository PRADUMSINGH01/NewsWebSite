      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-700 max-w-sm leading-relaxed mt-1">
                  Fast · Reliable · Independent — Trusted national and global
                  news source.
                </p>
          ...
          <nav
            ...
            className="col-span-1 lg:col-span-5 grid grid-cols-2 gap-6"
          >
            <div>
          ...
          <div className="col-span-1 lg:col-span-3">
            ...
            <p className="text-sm text-gray-700 mb-4">
              Get the latest headlines in your inbox — Subscribe for our weekly
              digest.
            </p>
        ...
        <div className="mt-10 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-gray-700">
          <p className="text-xs">
            &copy; {new Date().getFullYear()} hmarduniya — All Rights Reserved.
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs text-gray-600">
              Crafted by <strong className="font-semibold">hmarduniya</strong>
            </span>
          </div>
        </div>
      </div>
